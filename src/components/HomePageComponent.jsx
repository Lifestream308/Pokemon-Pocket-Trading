  ...
  return (
    <>
      <div className='mt-2 flex flex-col gap-8 px-[6%]'>
          <main className='flex flex-col gap-6 justify-center md:gap-10'>
            ...
            <div>
              <button className='px-4 py-2 rounded-lg bg-blue-500 text-white' onClick={() => handleCopy()}>Copy URL</button>
            </div>
            <div className='flex flex-col gap-1'>
              <p>Filters</p>
              {Object.keys(filterOut).map((key) => (
                <label key={key} className='px-2 py-1 w-fit'>
